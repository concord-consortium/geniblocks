...
var BasketView = function (_React$Component) {
  ...
  _createClass(BasketView, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: classes, key: id, onClick: this.handleClick },
        _react2.default.createElement('div', { className: 'basket-image' }),
        _react2.default.createElement(
          'div',
...
var BasketSetView = function BasketSetView(_ref2) {
  ...
  var basketViews = baskets.map(function (basket, index) {
    ...
    return _react2.default.createElement(BasketView, { basket: basket, id: id, key: id, index: index,
...
var EggView = function (_React$Component) {
  ...
  _createClass(EggView, [{
    ...
    value: function render() {
      ...
      var isSelected = _props.isSelected;
      var classes = 'clutch-egg' + (isSelected ? ' selected' : '');
      return _react2.default.createElement('div', { className: classes, width: width, key: id, onClick: this.handleClick });
    }
  }]);
